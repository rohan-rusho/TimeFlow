...
public class SecondsToHoursFragment extends Fragment {
    ...
    public SecondsToHoursFragment() {}

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_seconds_to_hours, container, false);
        ...
        btnConvert.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(input)) {
                Toast.makeText(getContext(), "Please enter seconds", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            try {
                ...
                String result = String.format("%.2f Hours", hours);
